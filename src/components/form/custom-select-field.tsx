              ...
              <PopoverTrigger asChild>
                <FormControl>
                  <Button
                    ...
                    className={cn(
                      "border-secondary-foreground/30 h-auto min-h-[2.5rem] w-full justify-between rounded-lg border bg-transparent px-3 py-2 shadow-none transition-all duration-200 hover:bg-transparent focus:border-transparent focus:ring-0 focus:outline-none focus-visible:ring-0",
                      triggerClassName,
                      {
