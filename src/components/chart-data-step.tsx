...
export function ChartDataStep({
  ...
  const renderChart = (isFileUpload = false) => {
    ...
    switch (chartType) {
      ...
      case "area":
        return (
          <CustomAreaChart {...commonProps} xAxisKey={axisKeys.xAxisKey} />
        );
      case "line":
        return (
          <CustomLineChart {...commonProps} xAxisKey={axisKeys.xAxisKey} />
        );
      case "pie":
        return (
          <CustomPieChart
            {...commonProps}
            nameKey={axisKeys.xAxisKey}
            valueKey={axisKeys.valueKeys[0] ?? ""}
          />
        );
      case "donut":
        return (
